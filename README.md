...
The short version: Mistral's general instruction tuning added essentially nothing on legal knowledge (+0.26pp). Domain fine-tuning added 8.67 percentage points. That gap is the whole point of this exercise.
